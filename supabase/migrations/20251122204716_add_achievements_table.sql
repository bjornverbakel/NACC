...
add constraint "achievements_pkey" PRIMARY KEY using index "achievements_pkey";
alter table "public"."user_achievements"
add constraint "user_achievements_pkey" PRIMARY KEY using index "user_achievements_pkey";
alter table "public"."user_achievements"
add constraint "user_achievements_achievement_id_fkey" FOREIGN KEY (achievement_id) REFERENCES public.achievements(id) not valid;
alter table "public"."user_achievements" validate constraint "user_achievements_achievement_id_fkey";
alter table "public"."user_achievements"
add constraint "user_achievements_user_id_ending_id_key" UNIQUE using index "user_achievements_user_id_ending_id_key";
alter table "public"."user_achievements"
add constraint "user_achievements_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;
...
create policy "Enable read access for all users" on "public"."achievements" as permissive for
select to public using (true);
create policy "Enable insert for users based on user_id" on "public"."profiles" as permissive for
...
create policy "Enable delete for users based on user_id" on "public"."user_achievements" as permissive for delete to authenticated using (
  (
    (
      SELECT auth.uid() AS uid
    ) = user_id
...
create policy "Enable insert for users based on user_id" on "public"."user_achievements" as permissive for
...
create policy "Enable users to update their own data only" on "public"."user_achievements" as permissive for
...
create policy "Enable users to view their own data only" on "public"."user_achievements" as permissive for
select to authenticated using (
    (
      (
        SELECT auth.uid() AS uid
...
create policy "Enable delete for users based on user_id" on "public"."user_endings" as permissive for delete to authenticated using (
  (
    (
      SELECT auth.uid() AS uid
    ) = user_id
...
create policy "Enable insert for users based on user_id" on "public"."user_endings" as permissive for
insert to authenticated with check (
    (
      (
        SELECT auth.uid() AS uid
...
create policy "Enable users to update their own data only" on "public"."user_endings" as permissive for
update to authenticated using (
    (
      (
        SELECT auth.uid() AS uid
...
create policy "Enable users to view their own data only" on "public"."user_endings" as permissive for
select to authenticated using (
    (
      (
        SELECT auth.uid() AS uid
...
create policy "Enable delete for users based on user_id" on "public"."user_sidequests" as permissive for delete to authenticated using (
  (
    (
      SELECT auth.uid() AS uid
    ) = user_id
...
create policy "Enable insert for users based on user_id" on "public"."user_sidequests" as permissive for
insert to authenticated with check (
    (
      (
        SELECT auth.uid() AS uid
...
create policy "Enable users to update their own data only" on "public"."user_sidequests" as permissive for
update to authenticated using (
    (
      (
        SELECT auth.uid() AS uid
...
create policy "Enable users to view their own data only" on "public"."user_sidequests" as permissive for
select to authenticated using (
    (
      (
        SELECT auth.uid() AS uid
