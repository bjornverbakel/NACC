...
alter table "public"."endings"
add constraint "endings_pkey" PRIMARY KEY using index "endings_pkey";
alter table "public"."profiles"
add constraint "profiles_pkey" PRIMARY KEY using index "profiles_pkey";
alter table "public"."sidequests"
add constraint "sidequests_pkey" PRIMARY KEY using index "sidequests_pkey";
alter table "public"."user_endings"
add constraint "user_endings_pkey" PRIMARY KEY using index "user_endings_pkey";
alter table "public"."user_sidequests"
add constraint "user_sidequests_pkey" PRIMARY KEY using index "user_sidequests_pkey";
alter table "public"."profiles"
...
alter table "public"."user_endings"
add constraint "user_endings_ending_id_fkey" FOREIGN KEY (ending_id) REFERENCES public.endings(id) ON DELETE CASCADE not valid;
alter table "public"."user_endings" validate constraint "user_endings_ending_id_fkey";
alter table "public"."user_endings"
add constraint "user_endings_user_id_ending_id_key" UNIQUE using index "user_endings_user_id_ending_id_key";
alter table "public"."user_endings"
add constraint "user_endings_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;
alter table "public"."user_endings" validate constraint "user_endings_user_id_fkey";
alter table "public"."user_sidequests"
add constraint "user_sidequests_sidequest_id_fkey" FOREIGN KEY (sidequest_id) REFERENCES public.sidequests(id) not valid;
alter table "public"."user_sidequests" validate constraint "user_sidequests_sidequest_id_fkey";
alter table "public"."user_sidequests"
add constraint "user_sidequests_user_id_ending_id_key" UNIQUE using index "user_sidequests_user_id_ending_id_key";
alter table "public"."user_sidequests"
add constraint "user_sidequests_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;
...
create policy "Enable read access for all users" on "public"."endings" as permissive for
select to public using (true);
create policy "Authenticated can insert own profile" on "public"."profiles" as permissive for
insert to authenticated with check ((auth.uid() = id));
create policy "Users can read their own profile" on "public"."profiles" as permissive for
...
create policy "Enable read access for all users" on "public"."sidequests" as permissive for
select to public using (true);
create policy "Users can delete their own user_endings" on "public"."user_endings" as permissive for delete to authenticated using ((auth.uid() = user_id));
create policy "Users can insert their own user_endings" on "public"."user_endings" as permissive for
insert to authenticated with check ((auth.uid() = user_id));
create policy "Users can read their own user_endings" on "public"."user_endings" as permissive for
select to authenticated using ((auth.uid() = user_id));
create policy "Users can update their own user_endings" on "public"."user_endings" as permissive for
update to authenticated using ((auth.uid() = user_id)) with check ((auth.uid() = user_id));
create policy "Users can delete their own user_sidequests" on "public"."user_sidequests" as permissive for delete to authenticated using ((auth.uid() = user_id));
create policy "Users can insert their own user_sidequests" on "public"."user_sidequests" as permissive for
insert to authenticated with check ((auth.uid() = user_id));
create policy "Users can read their own user_sidequests" on "public"."user_sidequests" as permissive for
select to authenticated using ((auth.uid() = user_id));
create policy "Users can update their own user_sidequests" on "public"."user_sidequests" as permissive for
update to authenticated using ((auth.uid() = user_id)) with check ((auth.uid() = user_id));